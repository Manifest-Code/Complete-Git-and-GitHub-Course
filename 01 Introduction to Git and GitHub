...
> My curated log of learning Git and GitHub from scratch — structured, simplified, and easy to undertand 🚀
...
## 🦉 Git and Github are different ☯️
...
## ✅ Account on Github
Another step that you have to follow is to create an account on Github. Go to the official site https://github.com/. And sign up for the GitHub to create new account. Add the personal details like user name, your email ID and sign up for the account.
